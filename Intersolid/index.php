...
<head>
    ...
    <title>Prioriza - Intersolid</title>
...
<header class="container-fluid d-flex justify-content-center mb-3">
    ...
    <div class="container mt-5">
        ...
        <div class="col-8 d-flex justify-content-start mb-3"> 
            ...
            echo "<input class='mx-3' type='checkbox' id='checkTodos' name='checkTodos'> Selecionar Todas";
        ...
        <div class="col-4 d-flex justify-content-end mb-3 p-2">
            <span>
